...
export default function CDFFinal() {
  ...
  return (
    <div style={{ height: 700, padding: 15, width: "100%" }}>
      ...
      <div ref={componentRef} className="MainPdCont">
        <div
          className="d-md-flex row justify-content-center mb-4"
          style={{ margin: 30 }}
        >
                          ...
                          <th>
                            {i.Quizzes.map((e, index) => {
                              ...
                              // }
                                ...
                                return (
                                  "& " + e?.title?.charAt(e.title.length - 1)
                                );
                              } else {
                                return (
                                  ", " + e?.title?.charAt(e.title.length - 1)
