              ...
              >
                <Box sx={style}>
                  ...
                  >
                    <CloseIcon
                      onClick={handleClose}
                      style={{ cursor: "pointer", color: "gray",marginRight: 10 }}
                    />
                  </Box>
                  <h4 className="mb-4 ms-5">INITIALIZE NEW COURSE</h4>

                  <form onSubmit={AddRepoCourse} className="ModalSize">
                    <div className="row">
                      <div className="col">
