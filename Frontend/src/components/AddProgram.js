    ...
    <>
      ...
      >
        <Card style={{ padding: 30, borderRadius: 10 }}>
          ...
          <div className="d-sm-flex justify-content-end  mb-4 ModalSize">
            <Box sx={{ minWidth: 220,}}>
              <FormControl fullWidth size="small">
                <InputLabel id="taskType" style={{ zIndex:0}}>Filter by Degree</InputLabel>
                <Select
                  value={report}
          ...
          >
            <Box sx={style}>
              <form onSubmit={handleSubmit} className="ModalSize">
