...
export default function CourseFolder() {
  ...
  return (
    <div class="" style={{ height: 700, width: "100%", padding: 20 }}>
      ...
      >
        <Box sx={style}>
          <form onSubmit={SubmitLec} className="ModalSize">
            <div class="mb-3">
      ...
      >
        <Box sx={style}>
          <form onSubmit={SubmitICEF} className="ModalSize">
            <div class="mb-3">
              <label class="form-label" for="customFile">
                <b>Upload ICEF</b>
              </label>
      ...
      >
        <Box sx={style}>
          <form onSubmit={SubmitObe} className="ModalSize">
            <div class="mb-3">
              <label class="form-label" for="customFile">
                <b>Upload OBE</b>
              </label>
      ...
      >
        <Box sx={style}>
          <form onSubmit={Submit1} className="ModalSize">
            <div class="mb-3">
              <label class="form-label" for="customFile">
                <b>Upload Best</b>
              </label>
